...
// Get current year and calculate cutoff year
$currentYear = date("Y");
...
<body>
    ...
    <div class="search-box">
        <form method="GET" action="index.php">
            <input type="text" name="search" placeholder="Search by Brand or Model" value="<?php echo $search; ?>">
    ...
    <div class="car-container">
        <?php if ($result->num_rows > 0): ?>
            <?php while($row = $result->fetch_assoc()): ?>
                <div class="car-card">
                    <div class="car-title"><?php echo $row['brand'] . " " . $row['model']; ?></div>
